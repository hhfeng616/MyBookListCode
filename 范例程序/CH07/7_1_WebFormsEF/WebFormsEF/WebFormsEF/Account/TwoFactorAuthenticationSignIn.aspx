<%@ Page Title="双因素验证" Language="C#" MasterPageFile="~/Site.Master" AutoEventWireup="true" CodeBehind="TwoFactorAuthenticationSignIn.aspx.cs" Inherits="WebFormsEF.Account.TwoFactorAuthenticationSignIn" %>
    ...
    <asp:PlaceHolder runat="server" ID="verifycode" Visible="false">
        <section>
            ...
            <div class="form-group">
                <asp:Label Text="密码:" runat="server" AssociatedControlID="Code" CssClass="col-md-2 control-label" />
                <div class="col-md-10">
